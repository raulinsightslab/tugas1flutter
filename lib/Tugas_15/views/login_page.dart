...
import 'package:tugas1flutter/Tugas_15/views/manage_data.dart';
import 'package:tugas1flutter/Tugas_15/views/register_page.dart';
...
class _LoginPage1 extends State<LoginPage1> {
  ...
  void loginUser() async {
    ...
    try {
      ...
      context.pushReplacement(UserProfilePage());
